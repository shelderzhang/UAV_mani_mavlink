/** @file
 *	@brief MAVLink comm protocol generated from UAV_mani.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_UAV_MANI_H
#define MAVLINK_UAV_MANI_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_UAV_MANI.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
